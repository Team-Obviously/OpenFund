...
async function registerRepository(repoName) {
    try {
...
async function donateToRepository(repoName, amount) {
    try {
...
async function assignStakeToIssue(repoName, issueName, amount) {
    try {
