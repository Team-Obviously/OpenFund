...
import {StakeComment} from "./types"
...
export class BamlAsyncClient {
  ...
  async ExtractStakeComment(
      user_comment: string,
      __baml_options__?: { tb?: TypeBuilder, clientRegistry?: ClientRegistry }
  ): Promise<StakeComment> {
    try {
      ...
      return raw.parsed() as StakeComment
    } catch (error: any) {
...
class BamlStreamClient {
  ...
  ExtractStakeComment(
      user_comment: string,
      __baml_options__?: { tb?: TypeBuilder, clientRegistry?: ClientRegistry }
  ): BamlStream<RecursivePartialNull<StakeComment>, StakeComment> {
    try {
      ...
      return new BamlStream<RecursivePartialNull<StakeComment>, StakeComment>(
        raw,
        (a): a is RecursivePartialNull<StakeComment> => a,
        (a): a is StakeComment => a,
        this.ctx_manager.cloneContext(),
        __baml_options__?.tb?.__tb(),
      )
    } catch (error) {
